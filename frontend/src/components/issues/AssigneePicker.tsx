...
export function AssigneePicker({ currentAssigneeId, onAssign }: AssigneePickerProps) {
      ...
      <div style={{ display: 'flex', gap: 'var(--space-2)' }}>
        {currentAssigneeId && (
          <button
            ...
            style={{ fontSize: 'var(--text-sm)', color: 'var(--danger)', fontWeight: 500 }}
          >
            Unassign
          </button>
        )}
        <button
          ...
          style={{ fontSize: 'var(--text-sm)', color: 'var(--text-tertiary)', fontWeight: 500 }}
        >
          Cancel
        </button>
      </div>
